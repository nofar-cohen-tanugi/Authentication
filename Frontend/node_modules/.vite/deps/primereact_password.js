...
import {
  ...
  require_react_is
} from "./chunk-AOHWNE2P.js";
import {
  IconBase
} from "./chunk-Z2S2NQA3.js";
import {
  InputText
} from "./chunk-UOELJGAB.js";
import {
  Portal
} from "./chunk-ZSBL4LCJ.js";
import {
  require_react_dom
...
var EyeSlashIcon = React9.memo(React9.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React9.useState(inProps.id), _React$useState2 = _slicedToArray(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  ...
  return React9.createElement("svg", _extends3({
    ...
    fill: "currentColor"
  })), React9.createElement("defs", null, React9.createElement("clipPath", {
    id: pathId
...
var Password = React10.memo(React10.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React10.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), overlayVisibleState = _React$useState2[0], setOverlayVisibleState = _React$useState2[1];
  var _React$useState3 = React10.useState(null), _React$useState4 = _slicedToArray2(_React$useState3, 2), meterState = _React$useState4[0], setMeterState = _React$useState4[1];
  var _React$useState5 = React10.useState(promptLabel), _React$useState6 = _slicedToArray2(_React$useState5, 2), infoTextState = _React$useState6[0], setInfoTextState = _React$useState6[1];
  var _React$useState7 = React10.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React10.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), unmaskedState = _React$useState10[0], setUnmaskedState = _React$useState10[1];
  ...
  var createIcon = function createIcon2() {
    ...
    if (props.toggleMask) {
      var content = React10.createElement("i", {
