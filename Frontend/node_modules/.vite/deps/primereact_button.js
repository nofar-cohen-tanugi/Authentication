...
var Ripple = React2.memo(React2.forwardRef(function() {
  ...
  return context && context.ripple || PrimeReact.ripple ? React2.createElement("span", {
    role: "presentation",
    ref: inkRef,
    className: "p-ink",
    onAnimationEnd
...
var Button = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  var createIcon = function createIcon2() {
    ...
    var icon3 = props.loading ? props.loadingIcon || React3.createElement(SpinnerIcon, _extends2({}, loadingIconProps, {
      spin: true
    })) : props.icon;
  ...
  var createLabel = function createLabel2() {
    ...
    return !props.children && !props.label && React3.createElement("span", {
      className: cx("label"),
  ...
  return React3.createElement(React3.Fragment, null, React3.createElement("button", rootProps, icon2, label, props.children, badge, React3.createElement(Ripple, null)), hasTooltip && React3.createElement(Tooltip, _extends2({
    target: elementRef,
